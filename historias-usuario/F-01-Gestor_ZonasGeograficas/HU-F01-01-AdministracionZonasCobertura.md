...
**QUIERO** registrar y delimitar zonas geográficas de cobertura logística mediante distritos y códigos postales  
...
- **Endpoints asociados:**
  - CRUD de zonas de cobertura bajo `/api/v1/zonas` (creación `POST /api/v1/zonas` y listado `GET /api/v1/zonas`, definido en [integraciones/api-contract.md](../../integraciones/api-contract.md)).
...
- **Reglas de negocio:**
  - El nombre de la zona es obligatorio y debe ser único; un distrito o código postal no puede pertenecer a más de una zona activa.
...
- [ ] **CA-03: Rechazo de zona o cobertura duplicada**
  - **DADO** que se intenta registrar una zona cuyo nombre, distrito o código postal ya se encuentra registrado en una zona activa.
...
- [ ] Pruebas de integración del CRUD verificando la creación exitosa de zonas válidas y el rechazo `409` para nombres, distritos o códigos postales duplicados.
- [ ] Formulario de Zona implementado en React + Tailwind con selección de distritos y códigos postales.
