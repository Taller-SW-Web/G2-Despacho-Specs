...
- `lineas` debe contener al menos un elemento.
- `sku` es obligatorio y `cantidad` debe ser mayor que cero.
- Despacho agrupa los SKU repetidos antes de consultar a Productos.
- Despacho calcula el peso total y el volumen total; el canal no envía esos totales.
...
|---|---|---|
| `DESP_ERROR_LINEAS_VACIAS` | `400` | No se enviaron productos |
